...
export const collectionsDescription: INodeProperties[] = [
			...
			"options": [
				{
					...
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/issue-tracking/collections"
						}
					}
				},
				{
					...
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/issue-tracking/collections/{{$parameter[\"collection_id\"]}}"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /issue-tracking/collections",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "GET /issue-tracking/collections/{collection_id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
