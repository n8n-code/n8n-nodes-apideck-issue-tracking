...
export const tagsDescription: INodeProperties[] = [
		{
			...
			"options": [
				{
					"name": "Collection Tags All",
					"value": "Collection Tags All",
					"action": "List Tags",
					"description": "List Tags",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/issue-tracking/collections/{{$parameter[\"collection_id\"]}}/tags"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /issue-tracking/collections/{collection_id}/tags",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
